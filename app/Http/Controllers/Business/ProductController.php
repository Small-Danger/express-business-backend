...
class ProductController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'sku.unique' => 'Ce code SKU existe déjà dans la base de données. Un produit avec ce code SKU a déjà été enregistré. Veuillez vérifier votre liste de produits ou utiliser un code SKU différent pour éviter les doublons.',
