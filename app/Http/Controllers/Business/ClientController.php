...
class ClientController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'code.unique' => 'Ce code est déjà utilisé par un autre client.',
            ...
            'phone.unique' => 'Ce numéro de téléphone est déjà utilisé par un autre client. Veuillez utiliser un numéro différent.',
            ...
            'whatsapp_phone.unique' => 'Ce numéro WhatsApp est déjà utilisé par un autre client. Veuillez utiliser un numéro différent.',
            ...
            'email.unique' => 'Cette adresse email est déjà utilisée par un autre client. Veuillez utiliser une adresse email différente.',
