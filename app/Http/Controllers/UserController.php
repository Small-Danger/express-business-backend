...
class UserController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'email.unique' => 'Cette adresse email existe déjà dans la base de données. Un utilisateur avec cette adresse email a déjà été enregistré. Veuillez vérifier votre liste d\'utilisateurs ou utiliser une adresse email différente pour éviter les doublons.',
