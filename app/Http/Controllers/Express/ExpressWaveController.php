...
class ExpressWaveController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'code.unique' => 'Ce code existe déjà dans la base de données. Une vague Express avec ce code a déjà été enregistrée. Veuillez vérifier votre liste de vagues ou utiliser un code différent pour éviter les doublons.',
